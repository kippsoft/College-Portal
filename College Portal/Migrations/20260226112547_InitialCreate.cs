        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseTutorId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Courses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Courses_AspNetUsers_CourseTutorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TutorApprovedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TutorApprovedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    FinanceApprovedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FinanceApprovedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamRegistrationRequests", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_CourseTutorId",
                table: "Courses",
                column: "CourseTutorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamRegistrationRequests_TraineeId",
